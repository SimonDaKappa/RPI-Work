...
public class graphStats extends UniversalActor  {
	...
	public graphStats(UAN __uan, UAL __ual, Object obj) {
		...
		if (obj instanceof UniversalActor.State || obj==null) {
			  ...
			  if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			    ...
			    createRemotely(__uan, __ual, "distributed.graphStats", sourceRef);
			  }
	...
	public class State extends UniversalActor .State {
		...
		public State(UAN __uan, UAL __ual) {
			super(__uan, __ual);
			addClassName( "distributed.graphStats$State" );
		...
		public void act(String[] arg) {
			...
			String path_a = arg[1];
			String path_b = arg[2];
			String nameserver = arg[3];
			String path_theaters = arg[4];
			int numPartitions = countPartitions(input);
			Object[] tmp = processTheaters(path_theaters);
			theaters = new String[tmp.length];
			for (int i = 0; i<tmp.length; i++){
				theaters[i] = (String)tmp[i];
			}
			{
			...
			try {
				...
				for (int i = 0; i<numPartitions; i++){
					...
					int theater_index = i%theaters.length;
					w[i] = ((worker)new worker(new UAN("uan://"+nameserver+"/a"+i), new UAL("rmsp://"+theaters[theater_index]+"/a"+i),this).construct());
				}
				in.close();
				{
		...
		public Object[] processTheaters(String path) {
			ArrayList_S theaters = new ArrayList_S();
			try {
				BufferedReader in = new BufferedReader(new FileReader(path));
				String theater;
				while ((theater=in.readLine())!=null) {
					theaters.list.add(theater);
				}
				in.close();
			}
			catch (IOException e) {
			...
			return (Object[])(theaters.list.toArray());
		}
	}
}