...
public:
  ...
  public:
    ...
    iterator(TreeNode* p,const ds_set* set__) : ptr_(p), set_(set__) {}
    iterator(const iterator& old) : ptr_(old.ptr_), set_(old.set_) {}
    ~iterator() {}
    iterator& operator=(const iterator& old) { ptr_ = old.ptr_; set_ = old.set_; return *this; }
